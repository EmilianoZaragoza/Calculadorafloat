...
// Calculadorafloat.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CCalculadorafloatApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CCalculadorafloatApp

CCalculadorafloatApp::CCalculadorafloatApp()
{
...
// Único objeto CCalculadorafloatApp

CCalculadorafloatApp theApp;


// Inicialización de CCalculadorafloatApp

BOOL CCalculadorafloatApp::InitInstance()
{
